import { createGrid, setCell, getCell, countNeighbors } from './src/engine/grid.js';
import { step } from './src/engine/step.js';
import { parseRule } from './src/engine/ruleParser.js';

// Mock types since we use JS
...
function assertEqualGrid(g1, g2, name) {
  let ok = true;
